...
class TDROIDKnockObjectOver(tfds.core.GeneratorBasedBuilder):
    """DatasetBuilder for T-DROID "knock <object> over" task, 70 demos @ 5 Hz control."""
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        ...
        data_dirs = \
                '/iris/u/moojink/prismatic-dev/DROID/data--2024-05-16--knock_object_over--5_hz--70_demos'
